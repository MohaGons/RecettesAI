...
import { PlusCircle, Search, Menu, X, Home, BookOpen, ChevronDown, Filter, User } from 'lucide-react';
        ...
        <div className="flex justify-between items-center relative">
          ...
          <div className="flex items-center space-x-8">
            ...
            <nav className="hidden lg:flex space-x-6">
              <Link href="/" className="hover:text-green-200 transition-colors py-2 flex items-center">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 bg-white text-gray-800 rounded-md shadow-lg py-2 min-w-48 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all transform -translate-y-2 group-hover:translate-y-0">
                  <Link href="/recipes" className="block px-4 py-2 hover:bg-green-50 hover:text-green-600">
                    Toutes les recettes
                  </Link>
                  <Link href="/recipes/search?type=Entrée" className="block px-4 py-2 hover:bg-green-50 hover:text-green-600">
                    Entrées
                  </Link>
                  <Link href="/recipes/search?type=Plat principal" className="block px-4 py-2 hover:bg-green-50 hover:text-green-600">
                    Plats principaux
                  </Link>
                  <Link href="/recipes/search?type=Dessert" className="block px-4 py-2 hover:bg-green-50 hover:text-green-600">
                    Desserts
                  </Link>
                </div>
              </div>
              
              <Link href="/recipes/search" className="hover:text-green-200 transition-colors py-2 flex items-center">
                <Filter size={16} className="mr-1" />
                Recherche avancée
              </Link>
              
              <Link href="/ingredients" className="hover:text-green-200 transition-colors py-2">
                Ingrédients
              </Link>
            </nav>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <form className="flex bg-green-700 rounded-lg px-3 py-2">
              <input 
                ...
                className="bg-transparent border-none outline-none text-white placeholder-green-300 w-64"
              />
              <button type="submit">
